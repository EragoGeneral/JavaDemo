...
public class DLTHttpRequest {
    ...
    public static void main(String[] args) {
    	...
    	//for(int count = 2003; count < 2017; count++){
    		...
    		String s=DLTHttpRequest.sendGet("http://trend.caipiao.163.com/dlt/","beginPeriod=17001&endPeriod=17057");
